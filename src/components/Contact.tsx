      ...
      <div className="section-padding">
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div>
            ...
            <AnimatedSection delay={0.3}>
              <div className="flex items-start gap-4 mb-10">
                ...
                <div>
                  <h3 className="text-[hsl(var(--foreground))] font-light mb-1">{t("address")}</h3>
                </div>
              </div>
            </AnimatedSection>
              ...
              <div className="flex items-start gap-4 mb-10">
                ...
                <div>
                  <a
                    ...
                    className="text-[hsl(var(--foreground))] font-light hover:text-[hsl(var(--primary))] transition-colors duration-300"
                  >
                    {t("phone")}
                  </a>
                </div>
            ...
            <AnimatedSection delay={0.5}>
              <div className="flex items-start gap-4 mb-10">
                <Mail className="w-5 h-5 text-[hsl(var(--primary))] mt-1 flex-shrink-0" />
                <div>
                  <a
            ...
            <AnimatedSection delay={0.6}>
              <div className="mb-10">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <h3 className="text-[hsl(var(--foreground))] font-light text-lg">
                    {t("hours.title")}
                  </h3>
                </div>
            ...
            <AnimatedSection delay={0.7}>
              <p className="text-[hsl(var(--muted-foreground))] text-sm font-light italic border-l-2 border-[hsl(var(--primary))] pl-4">
                {t("reservation")}
              </p>
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection direction="right" delay={0.4}>
            <div className="relative h-full min-h-[400px] border border-[hsl(var(--border))] overflow-hidden">
              <iframe
