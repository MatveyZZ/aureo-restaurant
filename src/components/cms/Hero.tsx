  ...
  return (
    ...
    >
      <div className="absolute inset-0 w-full h-full">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-b from-[hsl(var(--background))]/80 via-[hsl(var(--background))]/50 to-[hsl(var(--background))]" />
      ...
      <div className="relative z-10 text-center px-4 md:px-6 py-20 md:py-0">
        <div className="mb-4 md:mb-6">
          <div className="w-16 md:w-20 lg:w-24 h-px bg-linear-to-r from-transparent via-[hsl(var(--primary))] to-transparent mx-auto mb-6 md:mb-8" />
        </div>
      ...
      <div className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 md:gap-3">
        ...
        <div className="w-px h-6 md:h-8 bg-linear-to-b from-[hsl(var(--primary))] to-transparent" />
      </div>
    </section>
  );
}
